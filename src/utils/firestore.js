...
export const createShape = async (shape, userId, sessionId) => {
  console.log('[Firestore] createShape:', { shapeId: shape.id, type: shape.type, userId, sessionId });
...
export const updateShape = async (shapeId, updates, sessionId) => {
  console.log('[Firestore] updateShape:', { shapeId, updates, sessionId });
  ...
  try {
    ...
    console.log('[Firestore] updateShape ERROR:', { shapeId, error: error.message });
    // Silently ignore if shape was deleted by another user
    // This is expected in multiplayer scenarios
    return;
  }
};

export const deleteShape = async (shapeId) => {
  console.log('[Firestore] deleteShape:', { shapeId });
...
export const deleteShapesBatch = async (shapeIds) => {
  ...
  console.log('[Firestore] deleteShapesBatch:', { count: shapeIds.length, shapeIds });
...
export const updateCursor = async (userId, cursorData) => {
  console.log('[Firestore] updateCursor:', { userId, cursorData });
...
export const removeCursor = async (userId) => {
  console.log('[Firestore] removeCursor:', { userId });
...
export const updatePresence = async (userId, userData) => {
  console.log('[Firestore] updatePresence:', { userId, userData });
...
export const removePresence = async (userId) => {
  console.log('[Firestore] removePresence:', { userId });
...
export const addShapesBatch = async (shapes) => {
  console.log('[Firestore] addShapesBatch:', { count: shapes.length });
...
export const deleteAllShapes = async () => {
  console.log('[Firestore] deleteAllShapes');
...
export const updateShapesBatch = async (shapeUpdates, sessionId) => {
  ...
  console.log('[Firestore] updateShapesBatch:', { count: updateArray.length, shapeIds: updateArray.map(([id]) => id), sessionId });
...
export const updateCanvasBackgroundColor = async (backgroundColor, userId, sessionId) => {
  console.log('[Firestore] updateCanvasBackgroundColor:', { backgroundColor, userId, sessionId });
